...
class AccrualTransaction:
    transaction: TreasuryBillTransaction
...
class ReturnTransaction:
    ...
    def consume(self, accrual: TreasuryBillTransaction, quantity: Decimal):
...
@dataclass
class TreasuryBillTrade:
    symbol: str
    description: str
    transactions: list[TreasuryBillTransaction] = field(default_factory=list)
    closed: bool = False

    def close(self):
        self.closed = True

    def add_transaction(self, transaction: TreasuryBillTransaction):
        if self.closed:
